...
public class UserController {
    ...
    //Curl - http://localhost:8080/book-store/register
    ...
    //Curl - http://localhost:8080/book-store/get-user-by-id/1
    ...
    //Curl - http://localhost:8080/book-store/get-user-by-first-name/omi
    ...
    //Curl - http://localhost:8080/book-store/get-user-by-email/umeshkmaurya22@gmail.com
    ...
    //Curl - http://localhost:8080/book-store/get-all-users
    ...
    //Curl - http://localhost:8080/book-store/change-password?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoyfQ.S4iy11IshEhLyc1J5koLwTdRCKZdYFB8pvBq13oECwY&password=Signature7
    ...
    //Curl - http://localhost:8080/book-store/update-user-by-email/umeshkumaurya22@gmail.com
    ...
    //Curl - http://localhost:8080/book-store/user-log-in
